 ...
 * Last Modified: 2023-04-24 14:48:21
 * ------------------
...
constexpr u32
gl_target_type(erika::plugins::renderer::opengl::Buffer_Type type)
{
    switch (type) {
        case erika::plugins::renderer::opengl::Buffer_Type::Vertex:
            return GL_ARRAY_BUFFER;
        case erika::plugins::renderer::opengl::Buffer_Type::Index:
...
constexpr u32
gl_draw_mode(erika::plugins::renderer::opengl::Draw_Mode mode)
{
    switch (mode) {
        case erika::plugins::renderer::opengl::Draw_Mode::Points:
            return GL_POINTS;
        case erika::plugins::renderer::opengl::Draw_Mode::Lines:
            return GL_LINES;
        case erika::plugins::renderer::opengl::Draw_Mode::Triangles:
            return GL_TRIANGLES;
        default:
            return 0;
    }
...
{
    if (!is_bound()) {
        yuki::debug::Logger::error("erika", "Vertex_Buffer_Object::draw_arrays(): attempting to draw unbound buffer!");
        return;
    }
...
{
    if (!is_bound()) {
        yuki::debug::Logger::error("erika", "Vertex_Buffer_Object::draw_elements(): attempting to draw unbound buffer!");
        return;
    }
