...
int
qoi_write(const char* filename, const void* data, const qoi_desc* desc);
...
void*
qoi_encode(const void* data, const qoi_desc* desc, int* out_len);
...
static void
qoi_write_32(unsigned char* bytes, int* p, unsigned int v)
{
