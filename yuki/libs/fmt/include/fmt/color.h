...
FMT_CONSTEXPR inline text_style
operator|(emphasis lhs, emphasis rhs) noexcept
{
...
template<typename Char>
FMT_CONSTEXPR ansi_color_escape<Char>
make_emphasis(emphasis em) noexcept
{
...
template<typename Char>
inline void
fputs(const Char* chars, FILE* stream)
{
...
template<>
inline void
fputs<wchar_t>(const wchar_t* chars, FILE* stream)
{
...
template<>
inline void
reset_color<wchar_t>(FILE* stream)
{
...
void
vprint(std::FILE* f, const text_style& ts, const S& format, basic_format_args<buffer_context<type_identity_t<Char>>> args)
{
...
void
print(std::FILE* f, const text_style& ts, const S& format_str, const Args&... args)
{
