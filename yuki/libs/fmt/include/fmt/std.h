...
void
write_escaped_path(basic_memory_buffer<Char>& quoted, const std::filesystem::path& p)
{
...
template<>
inline void
write_escaped_path<char>(basic_memory_buffer<char>& quoted, const std::filesystem::path& p)
{
    auto s = p.u8string();
...
template<>
inline void
write_escaped_path<std::filesystem::path::value_type>(
...
auto
write_variant_alternative(OutputIt out, const T& v) -> OutputIt
{
