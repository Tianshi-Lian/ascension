...
auto
get_file(std::__stdoutbuf<char>&) -> FILE*;
#endif

inline bool
write_ostream_unicode(std::ostream& os, fmt::string_view data)
{
#if FMT_MSC_VERSION
...
inline bool
write_ostream_unicode(std::wostream&, fmt::basic_string_view<wchar_t>)
{
    return false;
}
...
void
format_value(buffer<Char>& buf, const T& value, locale_ref loc = locale_ref())
{
...
void
print(std::wostream& os, basic_format_string<wchar_t, type_identity_t<Args>...> fmt, Args&&... args)
{
